...
public final class AppUtils {
    ...
    public static void installApp(final File file) {
        ...
        DiscoverLib.getContext().startActivity(getInstallAppIntent(file, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        DiscoverLib.getContext().startActivity(getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean isAppInstalled(@NonNull final String packageName) {
        PackageManager packageManager = DiscoverLib.getContext().getPackageManager();
        try {
    ...
    public static boolean isAppDebug() {
        return isAppDebug(DiscoverLib.getContext().getPackageName());
    }
    ...
    public static boolean isAppDebug(final String packageName) {
        ...
        try {
            PackageManager pm = DiscoverLib.getContext().getPackageManager();
    ...
    public static boolean isAppSystem() {
        return isAppSystem(DiscoverLib.getContext().getPackageName());
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        DiscoverLib.getContext().startActivity(getLaunchAppIntent(packageName, true));
    }
    ...
    public static void relaunchApp(final boolean isKillProcess) {
        PackageManager packageManager = DiscoverLib.getContext().getPackageManager();
        Intent intent = packageManager.getLaunchIntentForPackage(DiscoverLib.getContext().getPackageName());
        if (intent == null) return;
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        DiscoverLib.getContext().startActivity(intent);
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(DiscoverLib.getContext().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final String packageName) {
        ...
        DiscoverLib.getContext().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(DiscoverLib.getContext().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return DiscoverLib.getContext().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(DiscoverLib.getContext().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(DiscoverLib.getContext().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(DiscoverLib.getContext().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(DiscoverLib.getContext().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(DiscoverLib.getContext().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(DiscoverLib.getContext().getPackageName());
    }
    ...
    public static String getAppSignatureSHA256() {
        return getAppSignatureSHA256(DiscoverLib.getContext().getPackageName());
    }
    ...
    public static String getAppSignatureMD5() {
        return getAppSignatureMD5(DiscoverLib.getContext().getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(DiscoverLib.getContext().getPackageName());
    }
    ...
    private static Intent getLaunchAppIntent(final String packageName, final boolean isNewTask) {
        Intent intent = DiscoverLib.getContext().getPackageManager().getLaunchIntentForPackage(packageName);
    ...
    private static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) DiscoverLib.getContext().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(DiscoverLib.getContext().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) DiscoverLib.getContext().getSystemService(Context.APP_OPS_SERVICE);
                //noinspection ConstantConditions
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) DiscoverLib.getContext()
